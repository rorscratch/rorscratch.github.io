...
let icon;
function preload(){
  icon = loadImage('img/RorscratchTransparent.png')
  porTop = loadImage('img/porTop2.png')
  porBot = loadImage('img/porBottom2.png')
  twitterLogo = loadImage('./img/2021 Twitter logo - white.png')
  henLogo = loadImage('./img/HicIcon.png')
  verLogo = loadImage('./img/versicon.png')
  rorLogo = loadImage('./img/rorscratch.png')
  fxLogo = loadImage('./img/fxicon.png')
}
...
function draw() {
  ...
  image(icon,-windowWidth/14,-windowWidth/14,windowWidth/7,windowWidth/7)
  pop()
  imageMode(CORNER)
  ...
  if (windowWidth <= windowHeight){
    ...
    image(rorLogo,windowWidth-(windowWidth/6.0),windowHeight-(windowWidth/15.0),windowWidth/7,windowWidth/25)
    windowMult=0
  }
}
